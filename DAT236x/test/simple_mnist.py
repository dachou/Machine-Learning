...
def simple_mnist(tensorboard_logdir=None):
    ...
    path = os.path.normpath(os.path.join(data_dir, "Data-train-15000_20180720_070615.txt"))
    check_path(path)
    ...
    # Load test data
    path = os.path.normpath(os.path.join(data_dir, "Data-test-5000_20180720_070615.txt"))
    check_path(path)
